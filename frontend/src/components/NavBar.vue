      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center gap-2 font-semibold text-xl select-none cursor-default group">
            <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-pink-400 to-rose-500 flex items-center justify-center text-white font-bold shadow-lg shadow-pink-500/20 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110">雾</div>
            <span class="relative">
              <span class="text-gray-800 dark:text-gray-100 font-bold tracking-wide">初春图床</span>
              <span class="absolute -bottom-0.5 left-0 w-full h-[2px] bg-pink-400/60 dark:bg-pink-500/50 rounded-full"></span>
            </span>
          </div>
        </div>
