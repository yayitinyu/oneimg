            ...
            <div class="flex items-center gap-2">
              <div class="relative" :class="{ 'z-50': activeCopyMenu === image.id }">
                ...
                <div
                  ...
                  class="copy-dropdown absolute right-0 top-full mt-1 w-28 bg-white/95 dark:bg-dark-200/95 rounded-xl shadow-2xl border border-light-200/80 dark:border-dark-100/80 backdrop-blur-xl"
                >
