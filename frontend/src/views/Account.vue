                        ...
                        <div class="setting-group mb-6">
                            ...
                            <div class="flex gap-2">
                                <input 
                                    ...
                                    type="text" 
                                    class="setting-input flex-1 px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 focus:ring-2 focus:ring-primary focus:border-primary dark:focus:ring-primary/70 dark:focus:border-primary/70 transition-colors outline-none"
                                    placeholder="设置您的昵称"
                                    maxlength="20"
                                />
                                <button 
